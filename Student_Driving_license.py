...
label_id_tag = canvas.create_text(25,60, font=('Times', '14', 'bold') ,text="ID :" + str(drivingid))
label_name_tag = canvas.create_text(30,100, font=('Times', '12', 'bold') ,text="Name :" + name)
label_dob_tag = canvas.create_text(52,120, font=('Times', '12', 'bold') ,text="Date of birth :" + bday)
label_pin_tag = canvas.create_text(32,140, font=('Times', '12', 'bold') ,text="Pin no. :" + str(pin))
label_address_tag = canvas.create_text(36,160, font=('Times', '12', 'bold') ,text="Address :" + address)
label_vehicle_type_tag = canvas.create_text(155,180, font=('Times', '12', 'bold') ,text="Authorisation to drive the following vehicles :" + ",".join(vehicletype))
